...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/scavenge/scavenge/commit
   */
  queryCommitAll = (
    query?: {
   ...
   * @request GET:/scavenge/scavenge/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<ScavengeQueryParamsResponse, RpcStatus>({
      path: `/scavenge/scavenge/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/scavenge/scavenge/scavenge
   */
  queryScavengeAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<ScavengeQueryAllScavengeResponse, RpcStatus>({
      path: `/scavenge/scavenge/scavenge`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
